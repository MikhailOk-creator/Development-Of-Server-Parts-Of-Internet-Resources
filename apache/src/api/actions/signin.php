...
if (!isset($name) and !isset($password)) {
    header("Location: http://localhost:8080/signin.html");
    exit();
}
...
if ($result->num_rows == 1) {
    ...
    header("Location: http://localhost:80/avaliable-options.php");
} else {
    echo "Неправильные данные <br>";
    echo "<a href='http://localhost:8080/signin.html'>Войти снова</.a>";
}
$connection->close();
exit();
